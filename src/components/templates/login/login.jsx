...
import { login } from '@/redux/feature/dataSlice'
import { logInValidation } from '@/validation/validation.yup'
  ...
  xl:px-5 lg:flex-row">
    <div className="flex flex-col items-center w-full pt-5 pr-10 pb-20 pl-10 lg:pt-20 lg:flex-row">
      ...
      <div className="w-full mt-20 mr-0 mb-0 ml-0 relative z-10 max-w-2xl lg:mt-0 lg:w-5/12">
        ...
        relative z-10">
          <p className="w-full text-4xl font-medium text-center leading-snug font-serif">Login for Your account</p>
